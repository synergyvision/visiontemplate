...
\pagestyle{fancy}
\lhead{\includegraphics[width=80px]{$headleft$}}
\rhead{\includegraphics[width=50px]{$headright$}}
\lfoot{$footleft$}
\cfoot{}
...
\pagecolor{azulvision}
\noindent
\includegraphics[width=5cm]{$headtitle$}\\[-1em]
\color{white}
\makebox[0pt][l]{\rule{1.3\textwidth}{1pt}}
\par
\noindent
\textbf{\textsf{$subtituloportada$}}\\
\Huge\textbf{$tituloportada$} \\ \\
\includegraphics[width=9cm]{$centertitle$}\\
\vfill
\noindent
\small{\textbf{\today}} \\ \\
\end{titlepage}
...
\pagecolor{azulvision}
\vspace*{5cm}
\centering\includegraphics[width=8cm]{$headtitle$}\\
\vspace*{1cm}
\noindent
\color{white}
